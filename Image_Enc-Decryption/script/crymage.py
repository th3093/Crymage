...
def __decrypt_message(enc):
    __dec = ''
    for char in enc:
        __dec += ''.join(chr(char[0]*100 + char[1]*10 + char[2]))
    return __dec
